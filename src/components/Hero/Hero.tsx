...
const Hero = () => {
  return (
    <div className="hero-wrapper flex items-end gap-[558px] pt-0 pr-[66px] pb-[120px] pl-[131px] relative">
      <button
        type="button"
        className="absolute top-[220px] left-0 text-[16px] flex flex-row-reverse items-center gap-2 w-[42px] pt-[20px] pb-[11px] bg-beigeBg text-white border border-transparent hover:bg-beigeBgLight hover:text-[16.5px]"
